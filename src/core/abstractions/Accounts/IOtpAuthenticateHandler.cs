...
public interface IOtpAuthenticateHandler
{
    ...
    /// <exception cref="ArgumentNullException"><c><paramref name="audience" /></c> is <c>null</c> -or- <c><paramref name="emailAddress" /></c> is <c>null</c> -or- <c><paramref name="otp" /></c> is <c>null</c>.</exception>
    /// <exception cref="ForbiddenException">The provided audience is not authorized -or- the provided OTP does not match the OTP of the user whose email address matches the provided email address -or- the provided OTP has expired.</exception>
